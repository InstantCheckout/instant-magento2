define([
    ...
    return {
        ...
        getCheckoutUrl: function (skuQtyPairs, cartId, source) {
        ...
        init: function () {
            ...
            return window.open('https://' + this.instantUrl, '', 'location=yes,height=' + windowHeight + ',width=' + windowWidth + ',top=' + posY + ',left=' + posX + ',scrollbars=yes,status=yes');
        },
        ...
        checkoutCustomerCart: function (
            ...
            sourceLocation) {
            let checkoutWindow;
            if (this.canSetWindowLocation()) {
                checkoutWindow = this.init();
